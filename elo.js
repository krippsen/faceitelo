...
function updateelo(){
  ...
  oReq.onload = function() {
    ...
    levelpic.src = "https://cdn-frontend.faceit.com/web/960/src/app/assets/images-compress/skill-icons/skill_level_"+ JSON.parse(oReq.responseText).games.cs2.skill_level + "_svg.svg";
